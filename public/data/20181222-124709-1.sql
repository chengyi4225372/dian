...
-- Records of `ob_admin`
-- -----------------------------
INSERT INTO `ob_admin` VALUES ('1', 'admin', 'e10adc3949ba59abbe56e057f20f883e', '1', '1545446078', '127.0.0.1', '18', '0', '1545446078');
...
CREATE TABLE `ob_admin_log` (
  ...
  `create_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='管理员日志';
...
INSERT INTO `ob_admin_log` VALUES ('4', '1', 'admin', 'Mozilla/5.0 (Windows NT 10.0; WOW64; Trident/7.0; rv:11.0) like Gecko', '127.0.0.1', 'http://www.openbms.com/admin/database/backup.html', 'POST', 'json', '{\"table\":[\"ob_ad\",\"ob_admin\",\"ob_admin_log\",\"ob_article\",\"ob_auth_group\",\"ob_auth_group_access\",\"ob_auth_rule\",\"ob_category\",\"ob_config\",\"ob_system\",\"ob_user\",\"ob_user_log\"],\"_verify\":\"0\"}', '备份了数据', '1542186830');
INSERT INTO `ob_admin_log` VALUES ('5', '1', 'admin', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36', '127.0.0.1', 'http://www.openbms.com/admin.html', 'POST', 'json', '{\"username\":\"admin\",\"password\":\"123456\",\"captcha\":\"whxa\"}', '登录了后台系统', '1542250483');
INSERT INTO `ob_admin_log` VALUES ('6', '1', 'admin', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36', '127.0.0.1', 'http://www.openbms.com/admin.html', 'POST', 'json', '{\"username\":\"admin\",\"password\":\"123456\",\"captcha\":\"gj66\"}', '登录了后台系统', '1542685333');
INSERT INTO `ob_admin_log` VALUES ('7', '1', 'admin', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36', '127.0.0.1', 'http://www.openbms.com/admin/ad/add.html', 'POST', 'json', '{\"image\":\"\\/public\\/upload\\/image\\/20181120\\/0db24b9da4233dd6520821646be8fa87.png\",\"category\":\"index\",\"name\":\"1212\",\"description\":\"121\",\"url\":\"212\",\"target\":\"_self\"}', '添加了广告图', '1542686020');
INSERT INTO `ob_admin_log` VALUES ('8', '1', 'admin', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36', '127.0.0.1', 'http://www.openbms.com/admin/ad/add.html', 'POST', 'json', '{\"image\":\"\\/public\\/upload\\/image\\/20181120\\/c5e9331289e9775c779e40d36a69bff7.png\",\"category\":\"index\",\"name\":\"121\",\"description\":\"212\",\"url\":\"\",\"target\":\"_self\"}', '添加了广告图', '1542686051');
INSERT INTO `ob_admin_log` VALUES ('9', '1', 'admin', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36', '127.0.0.1', 'http://www.openbms.com/admin/ad/del/id/1.html', 'POST', 'json', '{\"id\":\"1\"}', '删除了广告图', '1542686057');
INSERT INTO `ob_admin_log` VALUES ('10', '1', 'admin', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36', '127.0.0.1', 'http://www.openbms.com/admin/ad/del/id/2.html', 'POST', 'json', '{\"id\":\"2\"}', '删除了广告图', '1542686061');
INSERT INTO `ob_admin_log` VALUES ('11', '1', 'admin', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36', '127.0.0.1', 'http://www.openbms.com/admin/database/backup.html', 'POST', 'json', '{\"table\":[\"ob_ad\",\"ob_admin\",\"ob_admin_log\",\"ob_article\",\"ob_auth_group\",\"ob_auth_group_access\",\"ob_auth_rule\",\"ob_category\",\"ob_config\",\"ob_system\",\"ob_user\",\"ob_user_log\"],\"_verify\":\"0\"}', '备份了数据', '1542686288');
INSERT INTO `ob_admin_log` VALUES ('12', '1', 'admin', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36', '127.0.0.1', 'http://www.openbms.com/admin/database/del/time/1542686288.html', 'POST', 'json', '{\"time\":\"1542686288\"}', '删除了数据', '1542686297');
INSERT INTO `ob_admin_log` VALUES ('13', '1', 'admin', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36', '127.0.0.1', 'http://www.openbms.com/admin.html', 'POST', 'json', '{\"username\":\"admin\",\"password\":\"123456\",\"captcha\":\"qbkc\"}', '登录了后台系统', '1545286849');
INSERT INTO `ob_admin_log` VALUES ('14', '1', 'admin', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36', '127.0.0.1', 'http://www.openbms.com/admin/config/edit/id/2.html', 'POST', 'json', '{\"group\":\"website\",\"title\":\"\\u7f51\\u7ad9\\u540d\\u79f0\",\"name\":\"site_name\",\"type\":\"radio\",\"value\":\"OpenBMS\",\"options\":\"\",\"id\":\"2\"}', '修改了基本配置', '1545286861');
INSERT INTO `ob_admin_log` VALUES ('15', '1', 'admin', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36', '127.0.0.1', 'http://www.openbms.com/admin/config/edit/id/2.html', 'POST', 'json', '{\"group\":\"website\",\"title\":\"\\u7f51\\u7ad9\\u540d\\u79f0\",\"name\":\"site_name\",\"type\":\"radio\",\"value\":\"OpenBMS\",\"options\":\"1:\\u662f\\r\\n0:\\u5426\",\"id\":\"2\"}', '修改了基本配置', '1545286877');
INSERT INTO `ob_admin_log` VALUES ('16', '1', 'admin', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36', '127.0.0.1', 'http://www.openbms.com/admin/config/edit/id/2.html', 'POST', 'json', '{\"group\":\"website\",\"title\":\"\\u7f51\\u7ad9\\u540d\\u79f0\",\"name\":\"site_name\",\"type\":\"select\",\"value\":\"OpenBMS\",\"options\":\"1:\\u662f\\r\\n0:\\u5426\",\"id\":\"2\"}', '修改了基本配置', '1545286973');
INSERT INTO `ob_admin_log` VALUES ('17', '1', 'admin', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36', '127.0.0.1', 'http://www.openbms.com/admin/config/edit/id/2.html', 'POST', 'json', '{\"group\":\"website\",\"title\":\"\\u7f51\\u7ad9\\u540d\\u79f0\",\"name\":\"site_name\",\"type\":\"radio\",\"value\":\"OpenBMS\",\"options\":\"1:\\u662f\\r\\n0:\\u5426\",\"id\":\"2\"}', '修改了基本配置', '1545287091');
INSERT INTO `ob_admin_log` VALUES ('18', '1', 'admin', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36', '127.0.0.1', 'http://www.openbms.com/admin/config/edit/id/2.html', 'POST', 'json', '{\"group\":\"website\",\"title\":\"\\u7f51\\u7ad9\\u540d\\u79f0\",\"name\":\"site_name\",\"type\":\"radio\",\"value\":\"OpenBMS\",\"options\":\"\",\"id\":\"2\"}', '修改了基本配置', '1545288554');
INSERT INTO `ob_admin_log` VALUES ('19', '1', 'admin', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36', '127.0.0.1', 'http://www.openbms.com/admin/config/edit/id/2.html', 'POST', 'json', '{\"group\":\"website\",\"title\":\"\\u7f51\\u7ad9\\u540d\\u79f0\",\"name\":\"site_name\",\"type\":\"select\",\"value\":\"OpenBMS\",\"options\":\"1:\\u662f\\r\\n0:\\u5426\",\"id\":\"2\"}', '修改了基本配置', '1545288566');
INSERT INTO `ob_admin_log` VALUES ('20', '1', 'admin', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36', '127.0.0.1', 'http://www.openbms.com/admin/config/edit/id/2.html', 'POST', 'json', '{\"group\":\"website\",\"title\":\"\\u7f51\\u7ad9\\u540d\\u79f0\",\"name\":\"site_name\",\"type\":\"input\",\"value\":\"OpenBMS\",\"options\":\"\",\"id\":\"2\"}', '修改了基本配置', '1545288581');
INSERT INTO `ob_admin_log` VALUES ('21', '1', 'admin', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36', '127.0.0.1', 'http://www.openbms.com/admin.html', 'POST', 'json', '{\"username\":\"admin\",\"password\":\"123456\",\"captcha\":\"q5v7\"}', '登录了后台系统', '1545357015');
INSERT INTO `ob_admin_log` VALUES ('22', '1', 'admin', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36', '127.0.0.1', 'http://www.openbms.com/admin/config/system.html', 'POST', 'json', '{\"is_develop\":\"1\",\"website_status\":\"1\",\"colse_explain\":\"\",\"page_number\":\"10\"}', '更新系统设置', '1545357020');
INSERT INTO `ob_admin_log` VALUES ('23', '1', 'admin', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36', '127.0.0.1', 'http://www.openbms.com/admin.html', 'POST', 'json', '{\"username\":\"admin\",\"password\":\"123456\",\"captcha\":\"iks7\"}', '登录了后台系统', '1545444071');
INSERT INTO `ob_admin_log` VALUES ('24', '1', 'admin', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36', '127.0.0.1', 'http://www.openbms.com/admin/index/logout.html', 'GET', 'xml', '[]', '退出了后台系统', '1545445530');
INSERT INTO `ob_admin_log` VALUES ('25', '1', 'admin', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36', '127.0.0.1', 'http://www.openbms.com/admin.html', 'POST', 'json', '{\"username\":\"admin\",\"password\":\"123456\",\"captcha\":\"ewin\"}', '登录了后台系统', '1545446078');
INSERT INTO `ob_admin_log` VALUES ('26', '2', 'demo', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36', '127.0.0.1', 'http://www.openbms.com/admin.html', 'POST', 'json', '{\"username\":\"demo\",\"password\":\"123456\",\"captcha\":\"espv\"}', '登录了后台系统', '1545449154');
...
INSERT INTO `ob_system` VALUES ('is_develop', '1');
